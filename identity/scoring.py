...
def score_reliability(missed_total: int, reliability_max: int) -> float:
    # skor opada ako se odredjen broj rundi ne javlja
    return max(0.0, 1.0 - missed_total / reliability_max) if reliability_max else 1.0
...
def identity_score(
    ...
    return base * score_reliability(missed_total, reliability_max)